  ...
  const loginWithGoogle = async () => {
    ...
    const { error } =
      await supabase.auth.signInWithOAuth({
        provider: "google",
        options: {
          redirectTo: "https://task-manager-five-omega-38.vercel.app",
        },
      });
        ...
        <div className="max-w-lg w-full">
          ...
          <div className="bg-white rounded-2xl border border-slate-200 shadow-xl p-8">
            ...
            <button
              ...
              className={`w-full ${btnPrimary} flex items-center justify-center gap-3 mb-6 py-3.5 text-lg font-semibold bg-gradient-to-r from-slate-800 to-slate-900 hover:from-slate-900 hover:to-slate-900 shadow-md`}
            >
              {googleLoading ? (
